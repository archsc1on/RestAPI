                  ...
                  <div className="flex flex-col md:flex-row md:items-center gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 bg-muted rounded-md px-2.5 py-1 font-mono text-xs max-w-lg">
                        ...
                        <Button variant="ghost" size="icon" className="h-5 w-5 shrink-0" onClick={() => toggleVisibility(key.id)}>
                          {visibleKeys.has(key.id) ? <EyeOff className="h-3 w-3" /> : <Eye className="h-3 w-3" />}
                        </Button>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" className="h-5 w-5 shrink-0" onClick={() => copyText(key.key)}>
